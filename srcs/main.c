...
/*   Updated: 2015/02/20 12:22:03 by bmbarga          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
** 0- modifier la var de julia en fonction de la position
** de la souris a l'ecran.
...
int					main(int ac, char **av)
{
	...
	if (ac > 1)
	{
		...
		mlx_hook(fract.win, MotionNotify,
			PointerMotionMask, motion_notify, &fract);
